...
var initialize = edge.func({
    assemblyFile: __dirname + '\\..\\armaext.dll',
    typeName: 'armaext.Edge',
    methodName: 'InitializeInternal'
});

var csconsolelog = edge.func({
    assemblyFile: __dirname + '\\..\\armaext.dll',
    typeName: 'armaext.Edge',
    methodName: 'ConsoleLog'
});
console.log = function () {
    csconsolelog(JSON.stringify(arguments, null, ' '), function () { });
};

__dirname = require("path").join(__dirname, "..");
